...
_jf.push(['_setFont', 'lihsianti', 'css', '.lihsianti']);
_jf.push(['_setFont', 'lihsianti', 'alias', 'lihsianti']);
_jf.push(['_setFont', 'lihsianti', 'weight', 500]);
(function (A, p, c, m, l, q, r, h, B, D) {
  ...
  `//d3gc6cgx8oosp4.cloudfront.net/js/stable/v/5.0.7/id/330895371788`
);
