  ...
  return (
    <Link href={url}>
      <a className="absolute">
        ...
        <div className="absolute top-[645px] left-[585px] w-[210px] transiton hover:scale-105">
...
const ScrollThree = ({ title }: { title: string }) => (
  <>
    <svg className="absolute" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 298.74 75">
      <path
        style={{ fill: '#e6f4f4' }}
    ...
    <text className="absolute font-medium text-center w-full truncate translate-y-[14px] px-2">
      {title}
    </text>
  </>
)
